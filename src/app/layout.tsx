  ...
  return (
    ...
    <header className="flex mx-auto justify-between items-center max-w-[1300px] py-4 ">
        <div className="flex items-center gap-3">
            <svg className="w-10 md:w-16 lg:w-24 h-10 md:h-16 lg:h-24 "
            ...
            <svg className="w-8 md:w-12 lg:w-20 leading-5 md:h-7 lg:h-12 " viewBox="0 0 76 46" fill="none"
        ...
        <div className="hidden sm:flex gap-3 md:gap-5 lg:gap-9">
            <button
                className="uppercase font-bold text-xs text-white border-2 border-white rounded-[40px] py-1 px-3  md:py-2 lg:py-4 md:px-4 lg:px-9 ">CONTACT
                US
            </button>
            <button
                className="uppercase font-bold text-xs rounded-[40px] py-1 px-3 md:py-2 lg:py-4 md:px-4 lg:px-9 text-[#302c42]  bg-gradient-to-r from-[#8176AF] to-[#C0B7E8]">JOIN
                HYDRA
            </button>
        </div>
